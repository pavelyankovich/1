# Данные сценарии предназначены для помощь ручным тестировщиком
# и ускорения процесса ручного тестирования
 ...
 Feature: Регистрация нового пользователя
    ...
    Scenario: Регистрация нового пользователя
      ...
      Then В поле c id "exampleInputEmail1" ввожу "test_321@test.ru"
